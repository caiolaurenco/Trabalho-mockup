...
<body class="notific-page">
  ...
  <script>
    function marcarComoLido() {
      const notificacoes = document.querySelectorAll("#conteudo .flex4, #conteudo .flex5");

      notificacoes.forEach(div => {
        div.style.backgroundColor = "#e0e0e0"; // exemplo: muda para cinza
        div.style.opacity = "0.7"; // fica mais "apagado"
      });
    }
  </script>
